...
import DownloadCloud from "../../../components/shared/icons/cloud"
...
function Register() {
    ...
    const registerUser = async(data) => {
        ...
        const response = await fetchActions(`http://localhost:3000/api/register`, {
            method: 'POST',
            ...
            <div className="z-10 w-full max-w-xl px-5 xl:px-0">
                <form onSubmit={handleSubmit(registerUser)}>
                    ...
                    <div className="flex items-center justify-between mb-5 opacity-0 animate-fade-down" style={{animationDelay: "1.4s", animationFillMode: "forwards"}}>
                        <Button className='p-3 w-1/3 text-white hover:bg-white hover:text-black' type="submit">Register</Button>
                    </div>
